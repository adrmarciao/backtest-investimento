...
O sistema SHALL permitir ao usuário cadastrar, para cada ativo e cada ano, os seguintes indicadores fundamentalistas reais: P/L, P/VP, Dívida/EBITDA, ROE, DPA (Dividendo Por Ação), LPA (Lucro Por Ação) e VPA (Valor Patrimonial por Ação).
